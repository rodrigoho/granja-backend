...
io.on('connection', (socket) => {
  ...
  socket.on('user', (user) => {
    io.emit('msg', {
      author: '[System]',
      datetime: new Date(),
      text: `${user.user} just joined us on this chat room!`,
      avatar:
        'https://upload.wikimedia.org/wikipedia/commons/thumb/3/3b/Wrench_font_awesome.svg/1024px-Wrench_font_awesome.svg.png',
    });
  });
  socket.on('msg', (msg) => {
    console.log(msg);
